...
exports.getMovieById = (0, common_utilities_1.routeHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
  try {
    ...
    let downloadUrlArr = [...download_url_scraping_1.postIdDefultVal];
    ...
    if (!info) {
      ...
      const linkStatus = (0, common_utilities_1.checkDLUrl)(yield (0, common_utilities_1.getURLStatus)(info.tempLink[0]));
      if (!linkStatus) {
        (0, development_mode_1.default)(() => color_logger_1.default.warn('links are not valid'));
        const driveSeedPathSts = (0, common_utilities_1.checkDLUrl)(yield (0, common_utilities_1.getURLStatus)(info.driveSeedUrl[0]));
        if (driveSeedPathSts) {
