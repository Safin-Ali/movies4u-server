...
exports.GenerateLink = exports.postIdDefultVal = void 0;
      ...
      if (!postId || !postId.length) {
        ...
        yield (0, _app_1.useDb)(cl => __awaiter(this, void 0, void 0, function* () {
          yield cl.insertOne({
            ...
            tempLink: [...exports.postIdDefultVal]
          });
        }));
      } else {
...
GenerateLink.getDirectLinkDRC = driveSeedURL => __awaiter(void 0, void 0, void 0, function* () {
  ...
  try {
    ...
    if (matches && matches.length > 1) {
      const linkSts = (0, common_utilities_1.checkDLUrl)(yield (0, common_utilities_1.getURLStatus)(matches[1]));
      if (linkSts) {
...
GenerateLink.getDirectLinkDDL = (driveSeedURL, domain) => __awaiter(void 0, void 0, void 0, function* () {
  try {
    ...
    const linkActiveSts = (0, common_utilities_1.checkDLUrl)(yield (0, common_utilities_1.getURLStatus)(link));
